        ...
        <div className="booking-data-container">
            ...
            <div className="form-container">
                ...
                <div className="form-group">
                    ...
                    <input type="text" id="userLocation" name="userLocation" value={formData.userLocation} onChange={handleInputChange} placeholder="Location Selected" />
                </div>
                <div className="form-group">
                    <label htmlFor="tel">Phone No.:</label>
                    <input type="tel" id="tel" name="tel" value={formData.tel} onChange={handleInputChange} placeholder="Phone No." />
                </div>
                <div className="form-group">
                    <label htmlFor="drivingID">Driving ID:</label>
                    <input type="text" id="drivingID" name="drivingID" value={formData.drivingID} onChange={handleInputChange} placeholder="Driving ID" />
                </div>
                <div className="form-group">
                    <label htmlFor="vehicle_name">Selected Vehicle:</label>
                    <input type="text" id="vehicle_name" name="vehicle_name" value={formData.vehicle_name} onChange={handleInputChange} placeholder="Selected Vehicle" />
                </div>
                <div className="form-group">
                    <label htmlFor="vehicle_price">Vehicle Price:</label>
                    <input type="number" id="vehicle_price" name="vehicle_price" value={formData.vehicle_price} onChange={handleInputChange} placeholder="Vehicle Price" />
                </div>
                <div className="form-group">
                    <label htmlFor="vehicle_category">Vehicle Category:</label>
                    <input type="text" id="vehicle_category" name="vehicle_category" value={formData.vehicle_category} onChange={handleInputChange} placeholder="Vehicle Category" />
                </div>
                <div className="form-group">
                    <label htmlFor="pickUpDate">Pickup Date:</label>
                    <input type="date" id="pickUpDate" name="pickUpDate" value={formData.pickUpDate} onChange={handleInputChange} placeholder="Pickup Date" />
                </div>
                <div className="form-group">
                    <label htmlFor="dropOffDate">Drop-off Date:</label>
                    <input type="date" id="dropOffDate" name="dropOffDate" value={formData.dropOffDate} onChange={handleInputChange} placeholder="Drop-off Date" />
                </div>
                <div className="form-group">
                    <label htmlFor="time">Time:</label>
                    <input type="time" id="time" name="time" value={formData.time} onChange={handleInputChange} placeholder="Time" />
                </div>
                <div className="form-group">
                    <label htmlFor="rentAmount">Total Paid Amount:</label>
                    <input type="number" id="rentAmount" name="rentAmount" value={formData.rentAmount} onChange={handleInputChange} placeholder="Total Paid Amount" />
                </div>
                {editMode ? (
